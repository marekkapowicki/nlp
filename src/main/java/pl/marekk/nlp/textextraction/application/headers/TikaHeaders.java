...
public enum TikaHeaders {
    ...
    public static Map<String, String> toTikaHeaders(
            TextExtractionCommand command, Map<String, String> ocrAdditionalHeaders) {
        HeadersExtractionCommand headersExtractionCommand =
                new HeadersExtractionCommand(command, ocrAdditionalHeaders);
