...
public class TestTextExtractor extends TextExtractor {
  public TestTextExtractor(
      Function<TextExtractionCommand, TextExtractionResponseFactory> ocrFunction) {
    super(ocrFunction);
  }

  public static TestTextExtractor failure(int expectedCode, String expectedMessage) {
    return new TestTextExtractor(
        FailureTextExtractionResponseFactory.newInstance(expectedCode, expectedMessage));
  }

  public static TestTextExtractor success(String expectedResponseText) {
    return new TestTextExtractor(
        SuccessTextExtractionResponseFactory.newInstance(expectedResponseText));
  }
}
